...
export interface SeoProductionReadiness { readonly state: SeoProductionState; readonly canonical: { ready: boolean; reason?: string }; readonly providers: { searchConsole: { configured: boolean; ready: boolean }; googleActions: { configured: boolean; ready: boolean }; bing: { configured: boolean; ready: boolean }; yandex: { configured: boolean; ready: boolean }; indexNow: { configured: boolean; ready: boolean }; aiCitation: { configured: boolean; ready: boolean }; competitive: { configured: boolean; ready: boolean }; searchIntelligence: { configured: boolean; ready: boolean }; googlePlaces: { configured: boolean; ready: boolean }; googleRoutes: { configured: boolean; ready: boolean }; youtube: { configured: boolean; ready: boolean }; facebook: { configured: boolean; ready: boolean }; instagram: { configured: boolean; ready: boolean }; x: { configured: boolean; ready: boolean }; pinterest: { configured: boolean; ready: boolean }; linkedin: { configured: boolean; ready: boolean }; tiktok: { configured: boolean; ready: boolean }; reddit: { configured: boolean; ready: boolean } }; readonly blockers: readonly string[]; readonly warnings: readonly string[]; }
