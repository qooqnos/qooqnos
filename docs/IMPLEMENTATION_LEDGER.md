...
Migration safety:
- canonical migrations 0001–0039 remain numbered and are extended only through new migrations;
- migrations 0024–0039 are preserved in the canonical lock sequence.
...
Migration lock note: migration 0021 was refreshed before provisioning after a pre-apply SQL cleanup; migrations 0022–0039 are registered and locked in sequence from canonical SQL contents. Full external D1 application has not yet been executed.
