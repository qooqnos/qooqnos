...
| Localization / Documents / Analytics | localization registries + analytics projection tables | Localization registry implemented in migration 0072; Analytics implemented in migration 0075; Documents remains a separate gate |
