...
| Case & Support Operations | cases, case_types, case_queues, case_assignments, case_participants, case_events, case_notes, case_evidence_references, case_links, case_escalations, case_resolutions, case_slas, case_actions, case_templates | Core case lifecycle/assignment/escalation/resolution persistence implemented; SLA breach worker, explicit first-response event, and CaseAction approval/completion routes are live; queue dispatch and cross-domain action execution remain |
