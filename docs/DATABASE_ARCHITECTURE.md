...
BOOKING/CRM: customers, customer_preferences, customer_addresses, availability_rules, appointments, crm_timeline_events, crm_timeline_projections, loyalty_accounts
