...
- Latest fully verified code checkpoint is commit `aad9585e19c4326cb853f0facf2514cac5e20593`.
- GitHub Actions CI run `35897887513` and Phoenix verification run `35897887763` both passed for the current `main` checkpoint.
