...
export class RuntimeBootError extends Error { readonly phase: BootPhase; readonly cause?: unknown; constructor(phase: BootPhase, message: string, cause?: unknown) { super(message); this.name = "RuntimeBootError"; this.phase = phase; this.cause = cause; } }
