...
8. Localization context plus canonical locale/country/region/market/legal registry structures are implemented by migration 0072; the format-neutral Documents/Export composition boundary is implemented and runtime-registered, while PDF/Print renderers and durable artifact persistence remain downstream adapter gates. Analytics is implemented by migration 0075.
